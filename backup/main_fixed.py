...
# ----------------------------
# I2C + OLED Setup (128x32 display)
# ----------------------------
i2c = I2C(1, scl=Pin(3), sda=Pin(2), freq=400000)

# Initialize display with correct size: 128x32
...
# ----------------------------
# OLED Update Function (adjusted for 32 pixel height)
# ----------------------------
def update_display():
    oled.fill(0)
    ...
    # Timer display
    oled.text(format_time(elapsed), 20, 12)

    # Status text
    if running:
        oled.text("RUNNING", 35, 24)
    else:
        oled.text("STOPPED", 35, 24)
